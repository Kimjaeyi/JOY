...
<!-- start -->
	...
	<div class="abc">
		...
		<div class="aaa">
			<h5>배송정보</h5>
			<hr><br>
			<input type="text" class="form-control" id="inputname" value="김재이" placeholder="이름" style="width: 25%">
			<br>
			<input type="text" class="form-control" id="inputphone" value="010" placeholder="휴대폰" style="width: 9%; margin: 0 3% 0 0">
			<input type="text" class="form-control" id="inputphone" value="1234" style="width: 15%; margin: 0 3% 0 0">
			<input type="text" class="form-control" id="inputphone" value="5678" style="width: 15%">
			<br><br>
			<button type="button" id="findzipcode" onclick="sample6_execDaumPostcode();" style="display: inline; margin: 0 3% 0 0">우편번호 찾기</button>
			<input type="text" class="form-control" id="zipcode" style="width: 15%; display: inline" value="06611" readonly>
			<br><br>
			<input type="text" class="form-control" id="inputaddr" value="서울 서초구 서초대로 77길 55" placeholder="도로명주소" style="width:63.5%">
			<br>
			<input type="text" class="form-control" id="inputdetailaddr" value="3층" placeholder="상세주소" style="width: 50%; margin: 0 3% 0 0">
			<input type="text" class="form-control" id="inputextraaddr" value="(서초동)" placeholder="참고항목" style="width: 10%">
			<br><br>

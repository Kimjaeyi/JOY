		...
		<div class="row">
			...
			<div class="col-9">
				...
				<div class="row">
					...
					<div class="col-5">
						<p>회원 탈퇴를 하시면 모든 정보가 삭제되며, 탈퇴하신 아이디는 다시 이용할 수 없습니다.<br>
						신중하게 결정하셔서 진행해주세요.<br><br>
						회원 탈퇴 시 보유하셨던 회원정보 등은 모두 삭제되나, 탈퇴 후 부정 이용 방지를 목적으로<br>
						1개월 간 성명, 실명 인증번호, 아이디, 비밀번호, 이메일, 로그기록, 접속 IP를 보관합니다.
					</div>
				</div>
				<br>
